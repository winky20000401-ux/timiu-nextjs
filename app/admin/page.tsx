        ...
        <div className="admin-grid">
          ...
          <aside>
            <details className="admin-card workflow-panel">
              ...
              <h3>当前系统运行参数</h3>
              <div className="config-list">RSS_TRANSLATION_ENABLED=true<br />AI_REWRITE_ENABLED=false<br />FULL_ARTICLE_TRANSLATION=false<br />SIMILARITY=0.45<br />AUTO_PUBLISH={autoPublishEnabled ? "true" : "false"}</div>
            </details>
          </aside>
        </div>
      </div>
